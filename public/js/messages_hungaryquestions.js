...
function sendMessage() {
    let message= document.getElementById("questionHungary").value;
	...
	$.post('/message_question_hungary', newMessage, function(response) {
		$('#newMessage').show();
		$('#messageThailand').val('')
...
//send a new comment and show the sent comment in a new div
	...
	$.post('/comment_questions_hungary', newCommentInput, function(data) {
