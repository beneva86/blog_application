...
//send a new comment and show the sent comment in a new div
	...
	$.post('/comment_forum_thailand', newCommentInput, function(data) {
...
function sendMessage() {
    let message= document.getElementById("messageThailand").value;
...
$.post('/message_forum_thailand', newMessage, function(response) {
	$('#newMessage').show();
	$('#messageThailand').val('')
