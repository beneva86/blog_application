...
function sendMessage() {
    let message= document.getElementById("questionThailand").value;
	...
	$.post('/message_question_thailand', newMessage, function(response) {
		$('#newMessage').show();
		$('#messageThailand').val('')
...
//send a new comment and show the sent comment in a new div
	...
	$.post('/comment_questions_thailand', newCommentInput, function(data) {
